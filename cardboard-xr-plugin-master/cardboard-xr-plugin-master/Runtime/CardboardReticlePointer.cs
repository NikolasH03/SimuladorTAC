...
public class CardboardReticlePointer : MonoBehaviour
{
    ...
    /// </summary>
    private const float _RETICLE_MAX_DISTANCE = 3.0f;
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(transform.position, transform.forward, out hit, _RETICLE_MAX_DISTANCE))
        {
            ...
            if (_gazedAtObject != hit.transform.gameObject)
            {
                ...
                if (IsInteractive(_gazedAtObject))
                {
                    ...
                    _gazedAtObject?.SendMessage("SetEstaViendoObjeto", false);
                }
                ...
                if (IsInteractive(_gazedAtObject))
                {
                    ...
                    _gazedAtObject.SendMessage("SetEstaViendoObjeto", true);
                }
            }
        ...
        //if (results.Count > 0)
        //{
        //    Debug.Log(" MiDebug UI detectada: " + results[0].gameObject.name);
        //}
